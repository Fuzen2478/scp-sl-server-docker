...
RUN apt-get update && \
    apt-get install -y ca-certificates gnupg expect bsdutils moreutils && \
...
COPY Exiled.tar.gz /scpsl/Exiled.tar.gz
...
RUN tar -zxvf /scpsl/Exiled.tar.gz -C /home/scpsl/.
...
# CMD yes | head -n 1 | /scpsl/LocalAdmin 7777
